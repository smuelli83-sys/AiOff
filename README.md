...
qwen3-fast (Qwen3 7B Instruct): 100% im VRAM der RTX A1000 für blitzschnelle Alltags-Chats.

qwen3.6-27b (Qwen 3.6 27B): Hybrid-Modus (8 GB VRAM + 64 GB DDR5-RAM) als High-End-Allrounder für komplexe Logik.

qwen3.6-35b (Qwen 3.6 35B-A3B MoE): Mixture-of-Experts im Hybrid-Modus für maximale RAG- und Textanalyse-Tiefe.

deepseek-coder (DeepSeek-Coder-V2-Lite-Instruct): Speziell optimierter Code-Spezialist für Softwareentwicklung und Skripterstellung.

llama3-8b (Meta Llama 3 8B): Stabiles Backup-Modell, das vollständig im VRAM läuft.
